-- Actualizar base de datos sin transacción global (cada comando es independiente)
...
-- Agregar columnas faltantes a la tabla proyectos_demo
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
...
-- Agregar columnas faltantes a la tabla testimonios
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
...
-- Agregar constraint de calificación
DO $$
BEGIN
...
EXCEPTION WHEN OTHERS THEN
  -- Ignorar error si el constraint ya existe
  NULL;
END $$;
